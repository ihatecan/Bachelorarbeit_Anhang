...
if __name__ == "__main__":
    ...
    parser.add_argument("--number_of_feature_values", type=int)
    ...
    data_df = reduce_feature_values(data_df=data_df,column="SOLD_COUNTRY",number_of_feature_values = args.number_of_feature_values)
    ...
    predictions =  linear_reg.predict(X_train[features])
